...
public class presentacionActTest {
    ...
    @Test
    public void presentacionActTest() {
        ...
        ViewInteraction appCompatEditText2 = onView(
                allOf(withId(R.id.ptUsuario),
                        childAtPosition(
                                ...
                                3),
                        isDisplayed()));
        appCompatEditText2.perform(replaceText("Edi@gmail.com"), closeSoftKeyboard());

        ViewInteraction appCompatEditText3 = onView(
                allOf(withId(R.id.ptPassword),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
        ...
        ViewInteraction appCompatEditText4 = onView(
                allOf(withId(R.id.ptPassword), withText("12345678"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
        ...
        ViewInteraction appCompatButton4 = onView(
                allOf(withId(R.id.btnIngresar), withText("Ingresar"),
                        childAtPosition(
                                childAtPosition(
                                        withClassName(is("android.widget.LinearLayout")),
                                        5),
        ...
        ViewInteraction appCompatEditText5 = onView(
                allOf(withId(R.id.ptPassword), withText("12345678"),
                        childAtPosition(
                                ...
                                4),
                        isDisplayed()));
        appCompatEditText5.perform(replaceText("123455678"));

        ViewInteraction appCompatEditText6 = onView(
                allOf(withId(R.id.ptPassword), withText("123455678"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
