...
public class comparacionRostros extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_comparacionrostros);
        initComponents();
    }
    private void initComponents() {

        oriImage=findViewById(R.id.image1);
        testImage=findViewById(R.id.image2);
        buverify=findViewById(R.id.verify);
        ...
        buverify.setOnClickListener(v -> {
            ...
            if(distance<6.0)
                result_text.setText("SEMEJANTES");
            else
                result_text.setText("DIFERENTES");
