...
public class Registro extends CameraActivity  implements ImageReader.OnImageAvailableListener {
    ...
    private static final Registro.DetectorMode MODE = Registro.DetectorMode.TF_OD_API;
